...
def insert_tables(cur, conn):
    """
       This function iterates over the list of insert queries that insert the data from stage table to final 
       table.
       INPUTS:
        * cur the cursor variable of the database
        * conn the connection variable of the database
...
def main():
    """
        ...
        It reads the db credentials from the config file, connects to the database, loads the s3 files into sage 
        tables, loads the final tables from stage tables
